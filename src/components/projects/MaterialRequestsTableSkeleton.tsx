// ============================================================
// src/components/projects/MaterialRequestsTableSkeleton.tsx
// Pure Server Component skeleton for Material Requests Table.
// ============================================================

import React from "react";

export default function MaterialRequestsTableSkeleton() {
  return (
            ...
            {Array.from({ length: 5 }).map((_, idx) => (
              <tr key={idx} className="animate-pulse">
                <td className="px-4 py-3.5">
                  <div className="h-4 w-24 bg-gray-200 dark:bg-gray-700/70 rounded" />
                </td>
                <td className="px-4 py-3.5">
                ...
                <td className="px-4 py-3.5">
                  <div className="h-4 w-28 bg-gray-200 dark:bg-gray-700/70 rounded" />
                </td>
                <td className="px-4 py-3.5">
