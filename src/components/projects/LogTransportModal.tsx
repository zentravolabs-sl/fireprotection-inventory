...
// Shows a custom UI Notice Modal when the LKR 5M threshold is reached
// instead of native browser alert().
// ============================================================
...
export function LogTransportModal({
  ...
  return (
    <>
      ...
      <Modal isOpen={isOpen && !approvalNotice} onClose={onClose} title={`Log Transport Entry — Project #${projectCode}`}>
