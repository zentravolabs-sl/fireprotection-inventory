// ============================================================
// src/components/projects/ProjectStockTableSkeleton.tsx
// Pure Server Component skeleton for Project Stock Table.
// ============================================================

import React from "react";

export default function ProjectStockTableSkeleton() {
  return (
    <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-6 space-y-4">
      {/* Search Bar Skeleton */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="h-[38px] w-full sm:w-80 bg-gray-200 dark:bg-gray-800 rounded-lg animate-pulse" />
      </div>

      {/* Table Skeleton */}
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm text-gray-600 dark:text-gray-300">
          <thead className="bg-gray-50 dark:bg-gray-800 uppercase text-xs font-semibold tracking-wider">
            <tr>
            ...
            {Array.from({ length: 5 }).map((_, idx) => (
              <tr key={idx} className="animate-pulse">
                <td className="px-4 py-3.5">
                  <div className="h-4 w-36 bg-gray-200 dark:bg-gray-700/70 rounded" />
                </td>
                <td className="px-4 py-3.5">
                ...
                <td className="px-4 py-3.5">
                  <div className="h-4 w-20 bg-gray-200 dark:bg-gray-700/70 rounded" />
                </td>
                <td className="px-4 py-3.5">
                  <div className="h-4 w-14 bg-gray-200 dark:bg-gray-700/70 rounded" />
                </td>
                <td className="px-4 py-3.5">
                  <div className="h-4 w-14 bg-gray-200 dark:bg-gray-700/70 rounded" />
                </td>
                ...
                <td className="px-4 py-3.5">
                  <div className="h-6 w-20 bg-gray-200 dark:bg-gray-700/70 rounded-full" />
                </td>
                <td className="px-4 py-3.5 text-right">
                  <div className="h-7 w-24 bg-gray-200 dark:bg-gray-700/70 rounded-md ml-auto" />
                </td>
              </tr>
            ))}
          </tbody>
