...
// ============================================================
// src/components/dashboard/project-manager/PMProjectIssuesTable.tsx
// Project Issues & Blockers Tracking Widget.
// ============================================================

import React from "react";
import Link from "next/link";
import { AlertCircle, ArrowRight } from "lucide-react";
import { PMProjectIssueItem } from "@/lib/services/projectManagerDashboardService";

interface PMProjectIssuesTableProps {
  issues: PMProjectIssueItem[];
}
...
export function PMProjectIssuesTable({ issues }: PMProjectIssuesTableProps) {
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6 shadow-sm flex flex-col justify-between h-full">
      <div>
        ...
        <p className="text-xs text-gray-500 dark:text-gray-400 mb-4">
          On-site engineering blockers, shortages & delay reports
        </p>

        {issues.length === 0 ? (
          <div className="py-8 text-center text-xs text-gray-400">
            ✓ No open project issues reported.
          </div>
        ) : (
                ...
                >
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[11px] text-gray-500 dark:text-gray-400">
                      {iss.projectName} • <span className="text-gray-700 dark:text-gray-300 font-medium">Rep by {iss.reportedBy}</span>
                    </p>
                  </div>
