...
import { Check, Shield, Save, CheckSquare, Square, AlertCircle } from "lucide-react";
...
const CONCONFIGURABLE_ROLES: { role: UserRole; label: string; badgeColor: string }[] = [
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 p-3 shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-2">
          {CONCONFIGURABLE_ROLES.map(({ role, label, badgeColor }) => {
