...
export function LogOTModal({ isOpen, onClose, onSubmit, assignments, isSubmitting, preselectedId }: Props) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Log Overtime (OT)" maxWidth="max-w-lg">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <DatePicker
            selected={parseStringToDate(otDate)}
            onChange={(date: Date | null) => setOtDate(formatDateToString(date))}
