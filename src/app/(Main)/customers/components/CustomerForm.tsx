...
// ============================================================
// src/app/(Main)/customers/components/CustomerForm.tsx
...
export default function CustomerForm({
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
      ...
      <div>
        <label htmlFor="companyName" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">
          Company Name *
        </label>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          <label htmlFor="contactPerson" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">
