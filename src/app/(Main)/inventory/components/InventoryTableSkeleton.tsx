// ============================================================
// src/app/(Main)/inventory/components/InventoryTableSkeleton.tsx
// Pure Server Component skeleton for Inventory Master Table.
// ============================================================

export default function InventoryTableSkeleton() {
  return (
    <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-6 space-y-4">
      {/* Controls / Action Header Bar Skeleton */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="h-6 w-40 bg-gray-200 dark:bg-gray-800 rounded-lg animate-pulse" />
        <div className="h-[38px] w-28 bg-gray-200 dark:bg-gray-800 rounded-lg animate-pulse" />
      </div>
      ...
      <div className="overflow-x-auto">
        <table className="w-full text-left text-sm text-gray-600 dark:text-gray-300">
          <thead className="bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-200 uppercase text-xs font-semibold tracking-wider">
            <tr>
              <th className="px-4 py-3"><div className="h-3.5 w-4 bg-gray-200 dark:bg-gray-700/80 rounded animate-pulse" /></th>
              <th className="px-4 py-3"><div className="h-3.5 w-16 bg-gray-200 dark:bg-gray-700/80 rounded animate-pulse" /></th>
              <th className="px-4 py-3"><div className="h-3.5 w-12 bg-gray-200 dark:bg-gray-700/80 rounded animate-pulse mx-auto" /></th>
              ...
              <th className="px-4 py-3"><div className="h-3.5 w-10 bg-gray-200 dark:bg-gray-700/80 rounded animate-pulse mx-auto" /></th>
              <th className="px-4 py-3"><div className="h-3.5 w-20 bg-gray-200 dark:bg-gray-700/80 rounded animate-pulse ml-auto" /></th>
              <th className="px-4 py-3"><div className="h-3.5 w-16 bg-gray-200 dark:bg-gray-700/80 rounded animate-pulse ml-auto" /></th>
              <th className="px-4 py-3"><div className="h-3.5 w-14 bg-gray-200 dark:bg-gray-700/80 rounded animate-pulse mx-auto" /></th>
              <th className="px-4 py-3"><div className="h-3.5 w-14 bg-gray-200 dark:bg-gray-700/80 rounded animate-pulse ml-auto" /></th>
            </tr>
          </thead>
          <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
            {Array.from({ length: 5 }).map((_, idx) => (
              <tr key={idx} className="animate-pulse">
                ...
                <td className="px-4 py-3.5 text-center"><div className="w-8 h-8 bg-gray-200 dark:bg-gray-700/70 rounded-lg mx-auto" /></td>
                ...
                <td className="px-4 py-3.5 text-center"><div className="h-4 w-10 bg-gray-200 dark:bg-gray-700/70 rounded mx-auto" /></td>
                <td className="px-4 py-3.5 text-right"><div className="h-4 w-12 bg-gray-200 dark:bg-gray-700/70 rounded ml-auto" /></td>
                <td className="px-4 py-3.5 text-right"><div className="h-4 w-10 bg-gray-200 dark:bg-gray-700/70 rounded ml-auto" /></td>
                ...
                <td className="px-4 py-3.5 text-right">
                  <div className="flex items-center justify-end gap-2">
                    <div className="h-7 w-16 bg-gray-200 dark:bg-gray-700/70 rounded-md" />
                    <div className="h-7 w-16 bg-gray-200 dark:bg-gray-700/70 rounded-md" />
                  </div>
                </td>
              </tr>
