// ============================================================
// src/app/(Main)/tools/components/ToolTableSkeleton.tsx
// Pure Server Component skeleton for Tools Table.
// ============================================================
        ...
        <table className="w-full text-left text-sm text-gray-600 dark:text-gray-300">
          <thead className="bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-200 uppercase text-xs font-semibold tracking-wider">
            <tr>
              ...
              <th className="px-4 py-3 text-center"><div className="h-3.5 w-12 bg-gray-200 dark:bg-gray-700/80 rounded animate-pulse mx-auto" /></th>
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
            {Array.from({ length: 5 }).map((_, idx) => (
              <tr key={idx} className="animate-pulse">
                ...
                <td className="px-4 py-3.5 text-center"><div className="w-9 h-9 bg-gray-200 dark:bg-gray-700/70 rounded-lg mx-auto" /></td>
                ...
                <td className="px-4 py-3.5"><div className="h-6 w-16 bg-gray-200 dark:bg-gray-700/70 rounded-lg" /></td>
                <td className="px-4 py-3.5"><div className="h-6 w-20 bg-gray-200 dark:bg-gray-700/70 rounded-lg" /></td>
                <td className="px-4 py-3.5"><div className="h-4 w-24 bg-gray-200 dark:bg-gray-700/70 rounded" /></td>
                <td className="px-4 py-3.5"><div className="h-4 w-20 bg-gray-200 dark:bg-gray-700/70 rounded" /></td>
                <td className="px-4 py-3.5"><div className="h-4 w-20 bg-gray-200 dark:bg-gray-700/70 rounded" /></td>
                <td className="px-4 py-3.5"><div className="h-4 w-24 bg-gray-200 dark:bg-gray-700/70 rounded" /></td>
