// ============================================================
// src/app/(Main)/labour-types/components/LabourTypesTableSkeleton.tsx
// Pure Server Component skeleton for Labour Types Table.
// ============================================================

export default function LabourTypesTableSkeleton() {
  return (
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
            {Array.from({ length: 5 }).map((_, idx) => (
              <tr key={idx} className="animate-pulse">
                ...
                <td className="px-4 py-3.5"><div className="h-4 w-40 bg-gray-200 dark:bg-gray-700/70 rounded" /></td>
                <td className="px-4 py-3.5 text-center"><div className="h-4 w-8 bg-gray-200 dark:bg-gray-700/70 rounded mx-auto" /></td>
                <td className="px-4 py-3.5 text-center"><div className="h-6 w-16 bg-gray-200 dark:bg-gray-700/70 rounded-full mx-auto" /></td>
