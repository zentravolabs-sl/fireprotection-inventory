...
// Tools management page — React Server Component.
// ============================================================
...
export const metadata = {
  title: "Tools — CDN Fire Engineering",
...
export default async function ToolsPage({ searchParams }: PageProps) {
  ...
  const tools = await getTools({ search, condition, status });
    ...
    <div className="min-h-screen bg-[#080c12]">
      ...
      <nav className="bg-[#0d1117] border-b border-[#1e2a3d] shadow-[0_1px_0_0_#1e2a3d,0_4px_24px_rgba(0,0,0,0.45)] sticky top-0 z-10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 flex items-center gap-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-[#dce3ef]">Tools</span>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            <h1 className="text-2xl sm:text-3xl font-black text-[#dce3ef]">Tools Management</h1>
        ...
        {search && (
          <p className="text-sm text-[#5a657a] mb-4">
            ...
            {" — "}
            <Link href="/admin/tools" className="text-[#e02424] hover:underline font-medium">
              Clear Search
            </Link>
          </p>
        )}
