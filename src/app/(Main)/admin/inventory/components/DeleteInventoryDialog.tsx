...
// ============================================================
// src/app/(Main)/admin/inventory/components/DeleteInventoryDialog.tsx
      ...
      <div className="flex flex-col items-center text-center gap-4">
        ...
        <div className="flex items-center gap-3 w-full">
          ...
          <button
            ...
            disabled={isDeleting}
            className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-semibold text-white bg-red-600 hover:bg-red-700 rounded-xl transition-colors shadow-sm disabled:opacity-60"
          >
