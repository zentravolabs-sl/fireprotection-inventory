// ============================================================
// src/app/(Main)/fire-extinguishers/deliveries/loading.tsx
// Loading skeleton state for Client Deliveries page.
// ============================================================

import ExtinguisherDeliveriesTableSkeleton from "@/components/fire-extinguishers/ExtinguisherDeliveriesTableSkeleton";

export default function ClientDeliveriesLoading() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-6 space-y-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <ExtinguisherDeliveriesTableSkeleton />
      </div>
    </div>
  );
}
