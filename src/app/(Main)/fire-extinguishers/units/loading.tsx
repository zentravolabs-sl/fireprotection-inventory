// ============================================================
// src/app/(Main)/fire-extinguishers/units/loading.tsx
// Loading skeleton state for Physical Units page.
// ============================================================

import ExtinguisherUnitsTableSkeleton from "@/components/fire-extinguishers/ExtinguisherUnitsTableSkeleton";

export default function PhysicalUnitsLoading() {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 p-6 space-y-6">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <ExtinguisherUnitsTableSkeleton />
      </div>
    </div>
  );
}
