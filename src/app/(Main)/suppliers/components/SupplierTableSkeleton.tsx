// ============================================================
// src/app/(Main)/suppliers/components/SupplierTableSkeleton.tsx
// Pure Server Component skeleton for Suppliers Table.
// ============================================================
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-6 space-y-4">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="h-6 w-36 bg-gray-200 dark:bg-gray-800 rounded-lg animate-pulse" />
        <div className="h-[42px] w-32 bg-gray-200 dark:bg-gray-800 rounded-lg animate-pulse" />
      </div>
        ...
        <table className="w-full text-left text-sm text-gray-600 dark:text-gray-300">
          <thead className="bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-200 uppercase text-xs font-semibold tracking-wider">
            <tr>
              ...
              <th className="px-4 py-3"><div className="h-3.5 w-16 bg-gray-200 dark:bg-gray-700/80 rounded animate-pulse" /></th>
              <th className="px-4 py-3 hidden lg:table-cell"><div className="h-3.5 w-20 bg-gray-200 dark:bg-gray-700/80 rounded animate-pulse" /></th>
              <th className="px-4 py-3 hidden xl:table-cell"><div className="h-3.5 w-16 bg-gray-200 dark:bg-gray-700/80 rounded animate-pulse" /></th>
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
            {Array.from({ length: 5 }).map((_, idx) => (
              <tr key={idx} className="animate-pulse">
                ...
                <td className="px-4 py-3.5 hidden lg:table-cell"><div className="h-4 w-32 bg-gray-200 dark:bg-gray-700/70 rounded" /></td>
                <td className="px-4 py-3.5 hidden xl:table-cell"><div className="h-4 w-24 bg-gray-200 dark:bg-gray-700/70 rounded" /></td>
