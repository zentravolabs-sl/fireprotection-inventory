...
// ============================================================
// src/app/(Main)/suppliers/components/SupplierForm.tsx
...
export default function SupplierForm({
  ...
  const inputClass = (hasError: boolean) =>
    `w-full pl-9 pr-4 py-3 text-sm border rounded-xl outline-none transition-all duration-200
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
      ...
      {/* Contact Person */}
      <div>
        <label htmlFor="contactPerson" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Contact Person</label>
        <div className="relative">
      ...
      {/* Address */}
      <div>
        <label htmlFor="address" className="block text-sm font-semibold text-gray-700 dark:text-gray-300 mb-1.5">Address</label>
        <div className="relative">
          ...
          <textarea
            ...
            disabled={isSubmitting}
            className={`w-full pl-9 pr-4 py-3 text-sm border rounded-xl outline-none transition-all duration-200
              placeholder:text-gray-400 dark:placeholder:text-gray-500 text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-800 resize-none
              disabled:opacity-60 disabled:cursor-not-allowed
              ${errors.address
                ? "border-red-500 focus:ring-1 focus:ring-red-200 dark:focus:ring-red-900"
                : "border-gray-200 dark:border-gray-700 focus:border-red-500 focus:ring-1 focus:ring-red-200 dark:focus:ring-red-900"
