// ============================================================
// src/app/(Main)/suppliers/page.tsx
// Supplier management page â€” React Server Component.
// ============================================================
...
export const metadata = {
  title: "Suppliers â€” CDN Fire Engineering",
...
export default async function SuppliersPage({ searchParams }: PageProps) {
  ...
  const { suppliers, total, page: currentPage, limit, totalPages } = await getSuppliers({ search, page, limit: 5 });
  ...
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          <div>
            <h1 className="text-2xl sm:text-3xl font-black text-gray-900 dark:text-gray-100">Suppliers</h1>
        ...
        {search && (
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
            ...
            {" â€” "}
            <Link href="/suppliers" className="text-red-600 dark:text-red-400 hover:underline font-medium">
              Clear
            </Link>
          </p>
        )}
