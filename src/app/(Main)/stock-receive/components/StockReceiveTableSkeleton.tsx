// ============================================================
// src/app/(Main)/stock-receive/components/StockReceiveTableSkeleton.tsx
// Pure Server Component skeleton for Stock Receive Table.
// ============================================================

export default function StockReceiveTableSkeleton() {
  return (
    <div className="bg-white dark:bg-gray-900 rounded-xl border border-gray-200 dark:border-gray-800 shadow-sm p-6 space-y-4">
      {/* Controls / Header */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div className="h-6 w-48 bg-gray-200 dark:bg-gray-800 rounded-lg animate-pulse" />
        <div className="h-[42px] w-48 bg-gray-200 dark:bg-gray-800 rounded-lg animate-pulse" />
      </div>
        ...
        <table className="w-full text-left text-sm text-gray-600 dark:text-gray-300">
          <thead className="bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-200 uppercase text-xs font-semibold tracking-wider">
            <tr>
              ...
              <th className="px-4 py-3"><div className="h-3.5 w-20 bg-gray-200 dark:bg-gray-700/80 rounded animate-pulse" /></th>
              <th className="px-4 py-3"><div className="h-3.5 w-20 bg-gray-200 dark:bg-gray-700/80 rounded animate-pulse" /></th>
              <th className="px-4 py-3 text-center"><div className="h-3.5 w-10 bg-gray-200 dark:bg-gray-700/80 rounded animate-pulse mx-auto" /></th>
          ...
          <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
            {Array.from({ length: 5 }).map((_, idx) => (
              <tr key={idx} className="animate-pulse">
                ...
                <td className="px-4 py-3.5 text-center"><div className="h-4 w-8 bg-gray-200 dark:bg-gray-700/70 rounded mx-auto" /></td>
                <td className="px-4 py-3.5 text-right"><div className="h-4 w-16 bg-gray-200 dark:bg-gray-700/70 rounded ml-auto" /></td>
