// ============================================================
// src/app/(Main)/stock-receive/loading.tsx
// Loading skeleton state for Stock Receive page.
// ============================================================

import StockReceiveTableSkeleton from "./components/StockReceiveTableSkeleton";

export default function StockReceiveLoading() {
  return (
